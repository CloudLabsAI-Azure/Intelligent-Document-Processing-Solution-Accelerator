...
3. Search for the **idp<inject key="DeploymentID" enableCopy="true" />aegapi** resource in the search tab and click on it. This will now take you to a API connection page. (Image)
